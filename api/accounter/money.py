...
@permission_required('accounter.view_couriers_debt')
...
@permission_required('accounter.view_courier_payments')
...
@permission_required('accounter.accept_handover')
...
@permission_required('accounter.view_debt_summary')
...
@permission_required('accounter.export_couriers_debt')
...
@permission_required('accounter.view_movements_summary')
...
@permission_required('accounter.export_movements_summary')
