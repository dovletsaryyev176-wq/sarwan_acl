...
@permission_required('warehouse.create_transaction')
...
@permission_required('warehouse.view_transactions')
...
@permission_required('warehouse.delete_transaction')
...
@permission_required('warehouse.view_couriers_stocks')
...
@permission_required('warehouse.return_courier_stocks')
...
@permission_required('warehouse.list_warehouses')
