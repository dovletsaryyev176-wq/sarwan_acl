...
@permission_required('orders.calculate')
...
@permission_required('orders.monitoring')
...
@permission_required('orders.view_client_history')
...
@permission_required('orders.search_by_phone')
...
@permission_required('orders.view_couriers_info')
...
@permission_required('orders.view_specific_courier')
