...
@permission_required('courier.view_stocks')
...
@permission_required('courier.view_transactions')
...
@permission_required('courier.create_transfer')
...
@permission_required('courier.view_transaction_detail')
