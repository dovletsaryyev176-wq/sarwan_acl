...
@permission_required('courier.view_orders_summary')
...
@permission_required('courier.view_inventory')
...
@permission_required('courier.update_order_status')
...
@permission_required('courier.deliver_order')
...
@permission_required('courier.view_orders')
...
@permission_required('courier.view_order')
...
@permission_required('courier.add_order_note')
...
@permission_required('courier.view_order_notes')
...
@permission_required('courier.view_daily_payments')
...
@permission_required('courier.view_payments_summary')
