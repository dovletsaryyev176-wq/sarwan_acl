...
@permission_required('director.clients_by_price_type')
...
@permission_required('director.blocked_transports')
...
@permission_required('director.clients_by_district')
...
@permission_required('director.accepted_money')
...
@permission_required('director.orders_by_status')
...
@permission_required('director.yearly_monthly_income')
...
@permission_required('director.monthly_income')
