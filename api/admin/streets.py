...
@permission_required('streets.view')
def get_streets():
...
@permission_required('streets.create')
def add_street():
...
@permission_required('streets.update')
...
@permission_required('streets.block')
...
@permission_required('streets.unblock')
