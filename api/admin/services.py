    ...
    try:
        with conn.cursor() as cursor:
            ...
            for service in services:
                ...
                cursor.execute("""
                    SELECT sr.id, sr.product_id, p.name as product_name,
                           sr.product_state_id, ps.name as product_state_name,
                           sr.service_type, sr.quantity
...
@permission_required('services.toggle')
...
@permission_required('services.set_price')
...
@permission_required('services.delete_price')
...
@permission_required('services.add_rule')
...
@permission_required('services.delete_rule')
