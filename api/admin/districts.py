...
@permission_required('districts.view')
def get_districts():
...
@permission_required('districts.create')
def add_district():
...
@permission_required('districts.update')
...
@permission_required('districts.block')
...
@permission_required('districts.unblock')
...
@permission_required('districts.stats')
