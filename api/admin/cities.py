...
@permission_required('cities.create')
def add_city():
...
@permission_required('cities.update')
...
@permission_required('cities.block')
...
@permission_required('cities.unblock')
...
@permission_required('cities.full_list')
